...
description: >
  ...
  対話履歴から「目的を定める力」「文脈を渡す力」「結果を見極める力」「必要なときに軌道修正する力」
...
AIとの対話履歴から、目的を定め、必要な文脈を与え、結果を見極め、必要なときに軌道修正し、AI協働環境を進化させる力を評価する。
...
6. **AI協働プロフィール** — 5軸（目的設計力→文脈供給力→検証・採択力→対話操舵力→学習資産化力）のスコア・confidence・解説・エビデンス引用
7. **統制レイヤー所見** — 条件付き評価
